...
void init_style_1_INDICATOR_DEFAULT(lv_style_t *style) {
    lv_style_set_bg_color(style, lv_color_hex(0x02ff02));
    lv_style_set_line_width(style, 10);
    lv_style_set_radius(style, 0);
    lv_style_set_bg_opa(style, 255);
...
lv_style_t *get_style_1_INDICATOR_DEFAULT() {
    ...
    if (!style) {
        style = (lv_style_t *)lv_mem_alloc(sizeof(lv_style_t));
        lv_style_init(style);
        init_style_1_INDICATOR_DEFAULT(style);
    }
    return style;
};

void init_style_1_MAIN_DEFAULT(lv_style_t *style) {
    lv_style_set_bg_color(style, lv_color_hex(0x000000));
    lv_style_set_text_color(style, lv_color_hex(0x2196f3));
    lv_style_set_bg_opa(style, 255);
    lv_style_set_translate_y(style, 0);
...
lv_style_t *get_style_1_MAIN_DEFAULT() {
    ...
    if (!style) {
        style = (lv_style_t *)lv_mem_alloc(sizeof(lv_style_t));
        lv_style_init(style);
        init_style_1_MAIN_DEFAULT(style);
    }
    return style;
};
...
void add_style_1(lv_obj_t *obj) {
    (void)obj;
    lv_obj_add_style(obj, get_style_1_INDICATOR_DEFAULT(), LV_PART_INDICATOR | LV_STATE_DEFAULT);
    lv_obj_add_style(obj, get_style_1_MAIN_DEFAULT(), LV_PART_MAIN | LV_STATE_DEFAULT);
};

void remove_style_1(lv_obj_t *obj) {
    (void)obj;
    lv_obj_remove_style(obj, get_style_1_INDICATOR_DEFAULT(), LV_PART_INDICATOR | LV_STATE_DEFAULT);
    lv_obj_remove_style(obj, get_style_1_MAIN_DEFAULT(), LV_PART_MAIN | LV_STATE_DEFAULT);
};
...
void init_style_2_MAIN_DEFAULT(lv_style_t *style) {
    lv_style_set_bg_color(style, lv_color_hex(0xcc2b2b));
    lv_style_set_bg_opa(style, 255);
};
...
lv_style_t *get_style_2_MAIN_DEFAULT() {
    ...
    if (!style) {
        style = (lv_style_t *)lv_mem_alloc(sizeof(lv_style_t));
        lv_style_init(style);
        init_style_2_MAIN_DEFAULT(style);
    }
    return style;
};
...
void add_style_2(lv_obj_t *obj) {
    (void)obj;
    lv_obj_add_style(obj, get_style_2_MAIN_DEFAULT(), LV_PART_MAIN | LV_STATE_DEFAULT);
};

void remove_style_2(lv_obj_t *obj) {
    (void)obj;
    lv_obj_remove_style(obj, get_style_2_MAIN_DEFAULT(), LV_PART_MAIN | LV_STATE_DEFAULT);
};
...
void init_style_3_MAIN_DEFAULT(lv_style_t *style) {
    lv_style_set_text_font(style, &ui_font_orbitron_bold_20);
    lv_style_set_text_align(style, LV_TEXT_ALIGN_CENTER);
    lv_style_set_text_color(style, lv_color_hex(0xfefefe));
    lv_style_set_text_decor(style, LV_TEXT_DECOR_NONE);
...
lv_style_t *get_style_3_MAIN_DEFAULT() {
    ...
    if (!style) {
        style = (lv_style_t *)lv_mem_alloc(sizeof(lv_style_t));
        lv_style_init(style);
        init_style_3_MAIN_DEFAULT(style);
    }
    return style;
};
...
void add_style_3(lv_obj_t *obj) {
    (void)obj;
    lv_obj_add_style(obj, get_style_3_MAIN_DEFAULT(), LV_PART_MAIN | LV_STATE_DEFAULT);
};

void remove_style_3(lv_obj_t *obj) {
    (void)obj;
    lv_obj_remove_style(obj, get_style_3_MAIN_DEFAULT(), LV_PART_MAIN | LV_STATE_DEFAULT);
};
